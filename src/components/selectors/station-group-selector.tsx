...
export interface StationGroupSelectorProps {
  value?: string | null;
  onChange?: (stationGroupId: string | null) => void;
  disabled?: boolean;
  label?: string;
  error?: boolean;
  helperText?: string;
...
export function StationGroupSelector({
  value,
  onChange,
  disabled = false,
  label = 'StationGroup',
  ...
  const handleChange = useCallback(
    (_event: any, newValue: StationGroupEntity | null) => {
      setSelectedStationGroup(newValue);
