...
export interface IoTDeviceSelectorProps {
  value?: string | null;
  onChange?: (ioTDeviceId: string | null) => void;
  disabled?: boolean;
  label?: string;
  error?: boolean;
  helperText?: string;
...
export function IoTDeviceSelector({
  ...
  const { data: entityById, isFetching: isFetchingById } = useGetIoTDeviceById(value || '', {
