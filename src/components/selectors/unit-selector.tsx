...
import { useSearchUnit, useGetUnitById } from 'src/api/hooks/generated/use-unit';
...
export function UnitSelector({
  ...
  const { data: entityById, isFetching: isFetchingById } = useGetUnitById(value || '', {
    enabled: !!value && !selectedUnit,
  });
  ...
  const { data: searchResults, isFetching: isFetchingSearch } = useSearchUnit({
