export default {
  ...
  'solar:link-bold-duotone': {
    body: '<g fill="currentColor"><path d="M9.172 16.243a.75.75 0 0 0 0-1.061l-2.829-2.828a4.25 4.25 0 1 1 6.01-6.01l2.829 2.828a.75.75 0 0 0 1.06-1.06l-2.828-2.829a5.75 5.75 0 0 0-8.132 8.132l2.829 2.828a.75.75 0 0 0 1.06 0Z" opacity="0.5"/><path d="m16.95 14.828l2.828 2.829a5.75 5.75 0 0 1-8.131 8.132l-2.829-2.829a.75.75 0 1 1 1.061-1.06l2.828 2.828a4.25 4.25 0 1 0 6.011-6.01l-2.828-2.829a.75.75 0 0 1 1.06-1.06Z"/></g>',
  },
  'solar:diskette-bold': {
    body: '<path fill="currentColor" fill-rule="evenodd" d="M2.25 12c0-4.714 0-7.071 1.465-8.536C5.179 2 7.535 2 12.25 2h.018c1.688 0 3.002 0 4.084.234c1.164.251 2.141.767 3.111 1.737l.837.837c.97.97 1.486 1.947 1.737 3.112c.234 1.081.234 2.395.234 4.083V12c0 4.714 0 7.071-1.465 8.535C19.32 22 16.964 22 12.25 22c-4.714 0-7.071 0-8.535-1.465C2.25 19.072 2.25 16.714 2.25 12Zm11 5.75a.75.75 0 0 1-.75-.75v-3.5a.75.75 0 0 1 1.5 0V17a.75.75 0 0 1-.75.75m-4.5 0a.75.75 0 0 1-.75-.75v-3.5a.75.75 0 0 1 1.5 0V17a.75.75 0 0 1-.75.75m7.5 0a.75.75 0 0 1-.75-.75v-3.5a.75.75 0 0 1 1.5 0V17a.75.75 0 0 1-.75.75" clip-rule="evenodd"/><path fill="currentColor" d="M14.134 2.197a6.846 6.846 0 0 0-1.884-.197H12a.75.75 0 0 0-.75.75v2a.75.75 0 0 0 .75.75h3.5a.75.75 0 0 0 .75-.75a.75.75 0 0 1 0-.031a7.19 7.19 0 0 0-.031-.315c-.037-.312-.113-.738-.307-1.269a2.817 2.817 0 0 0-.778-.938Z" opacity="0.5"/>',
  },
  'solar:copy-bold': {
    body: '<path fill="currentColor" fill-rule="evenodd" d="M15 1.25h-4.056c-1.838 0-3.294 0-4.433.153c-1.172.158-2.121.49-2.87 1.238c-.748.749-1.08 1.698-1.238 2.87c-.153 1.14-.153 2.595-.153 4.433V16a3.751 3.751 0 0 0 3.166 3.705c.137.764.402 1.416.932 1.947c.602.602 1.36.86 2.26.982c.867.116 1.97.116 3.337.116h3.11c1.367 0 2.47 0 3.337-.116c.9-.122 1.658-.38 2.26-.982c.602-.602.86-1.36.982-2.26c.116-.867.116-1.97.116-3.337v-3.11c0-1.367 0-2.47-.116-3.337c-.122-.9-.38-1.658-.982-2.26c-.531-.53-1.183-.795-1.947-.932A3.751 3.751 0 0 0 15 1.25M6.75 15A2.25 2.25 0 0 1 4.5 12.75v-2.694c0-1.907.002-3.262.14-4.29c.135-1.005.389-1.585.812-2.008c.423-.423 1.003-.677 2.009-.812c1.027-.138 2.382-.14 4.289-.14H15c1.24 0 2.25 1.01 2.25 2.25v.004c-1.15.022-2.05.08-2.8.169c-.899.106-1.658.32-2.26.874c-.603.555-.856 1.262-.981 2.104c-.121.816-.159 1.83-.159 3.108v3.056c0 1.279.038 2.292.16 3.109c.061.409.157.768.31 1.074A2.25 2.25 0 0 1 6.75 15" clip-rule="evenodd" opacity="0.5"/><path fill="currentColor" d="M13.945 3.945c-.68-.068-1.535-.103-2.695-.103c-1.907 0-3.261.002-4.29.14c-1.005.135-1.585.389-2.008.812c-.423.423-.677 1.003-.812 2.009c-.138 1.027-.14 2.382-.14 4.289c0 1.16.035 2.015.103 2.695A2.25 2.25 0 0 0 6.75 15h.006c-.022-1.15-.08-2.05-.169-2.8c-.106-.899-.32-1.658-.874-2.26c-.555-.603-1.262-.856-2.104-.981C2.793 8.838 1.78 8.8.5 8.8v-.744c0-1.838 0-3.294.153-4.433c.158-1.172.49-2.121 1.238-2.87c.749-.748 1.698-1.08 2.87-1.238c1.14-.153 2.595-.153 4.433-.153H15c.92 0 1.737 0 2.437.056a3.75 3.75 0 0 0-3.492 3.527"/>',
  },
  'solar:document-add-bold-duotone': {
    body: '<path fill="currentColor" d="M3 10c0-3.771 0-5.657 1.172-6.828C5.343 2 7.229 2 11 2h2c3.771 0 5.657 0 6.828 1.172C21 4.343 21 6.229 21 10v4c0 3.771 0 5.657-1.172 6.828C18.657 22 16.771 22 13 22h-2c-3.771 0-5.657 0-6.828-1.172C3 19.657 3 17.771 3 14z" opacity="0.5"/><path fill="currentColor" d="M12 8.25a.75.75 0 0 1 .75.75v2.25H15a.75.75 0 0 1 0 1.5h-2.25V15a.75.75 0 0 1-1.5 0v-2.25H9a.75.75 0 0 1 0-1.5h2.25V9a.75.75 0 0 1 .75-.75"/>',
  },
  'solar:calculator-bold': {
    body: '<path fill="currentColor" fill-rule="evenodd" d="M3.464 3.464C2 4.93 2 7.286 2 12s0 7.071 1.464 8.535C4.93 22 7.286 22 12 22s7.071 0 8.535-1.465C22 19.072 22 16.714 22 12s0-7.071-1.465-8.536C19.072 2 16.714 2 12 2s-7.071 0-8.536 1.464M7.25 8A.75.75 0 0 1 8 7.25h8a.75.75 0 0 1 .75.75v2a.75.75 0 0 1-.75.75H8A.75.75 0 0 1 7.25 10zm0 5a.75.75 0 0 1 .75-.75h.01a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1-.75-.75m0 3a.75.75 0 0 1 .75-.75h.01a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1-.75-.75m3.75-3.75a.75.75 0 0 0 0 1.5h.01a.75.75 0 0 0 0-1.5zm-.75 3a.75.75 0 0 1 .75-.75h.01a.75.75 0 0 1 0 1.5H11a.75.75 0 0 1-.75-.75m3.75-3.75a.75.75 0 0 0 0 1.5h.01a.75.75 0 0 0 0-1.5zm2.25.75a.75.75 0 0 1 .75-.75h.01a.75.75 0 0 1 0 1.5H16a.75.75 0 0 1-.75-.75m.75 2.25a.75.75 0 0 0 0 1.5h.01a.75.75 0 0 0 0-1.5z" clip-rule="evenodd"/>',
  },
  ...
  'solar:arrow-down-bold': {
    body: '<path fill="currentColor" d="M12 3.25a.75.75 0 0 1 .75.75v13.19l5.72-5.72a.75.75 0 1 1 1.06 1.06l-7 7a.75.75 0 0 1-1.06 0l-7-7a.75.75 0 1 1 1.06-1.06l5.72 5.72V4a.75.75 0 0 1 .75-.75"/>',
  },
  'solar:arrow-up-bold': {
    body: '<path fill="currentColor" d="M12 20.75a.75.75 0 0 1-.75-.75V6.81l-5.72 5.72a.75.75 0 0 1-1.06-1.06l7-7a.75.75 0 0 1 1.06 0l7 7a.75.75 0 1 1-1.06 1.06L12.75 6.81V20a.75.75 0 0 1-.75.75"/>',
  },
  'solar:layers-bold': {
    body: '<path fill="currentColor" d="M2.5 8.5c0-.465 0-.697.075-.883a1.5 1.5 0 0 1 .542-.542c.186-.075.418-.075.883-.075h16c.465 0 .697 0 .883.075a1.5 1.5 0 0 1 .542.542c.075.186.075.418.075.883s0 .697-.075.883a1.5 1.5 0 0 1-.542.542c-.186.075-.418.075-.883.075H4c-.465 0-.697 0-.883-.075a1.5 1.5 0 0 1-.542-.542C2.5 9.197 2.5 8.965 2.5 8.5" opacity="0.5"/><path fill="currentColor" d="M2.5 15.5c0-.465 0-.697.075-.883a1.5 1.5 0 0 1 .542-.542c.186-.075.418-.075.883-.075h16c.465 0 .697 0 .883.075a1.5 1.5 0 0 1 .542.542c.075.186.075.418.075.883s0 .697-.075.883a1.5 1.5 0 0 1-.542.542c-.186.075-.418.075-.883.075H4c-.465 0-.697 0-.883-.075a1.5 1.5 0 0 1-.542-.542c-.075-.186-.075-.418-.075-.883" opacity="0.7"/>',
  },
  'solar:sort-vertical-bold': {
    body: '<path fill="currentColor" fill-rule="evenodd" d="M6.47 4.47a.75.75 0 0 1 1.06 0l3 3a.75.75 0 0 1-1.06 1.06L7.75 6.81v10.44a.75.75 0 0 1-1.5 0V6.81L4.53 8.53a.75.75 0 0 1-1.06-1.06zM17.75 6.75a.75.75 0 0 0-1.5 0v10.44l-1.72-1.72a.75.75 0 1 0-1.06 1.06l3 3a.75.75 0 0 0 1.06 0l3-3a.75.75 0 1 0-1.06-1.06l-1.72 1.72z" clip-rule="evenodd"/>',
  },
};
