            ...
            {isEdit && id ? (
              <Card sx={{ p: 3 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Click the button above to manage machine mappings for this stop reason on a
              ...
              <Card sx={{ p: 3, bgcolor: 'background.neutral' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Machine mapping will be available after creating the stop reason. Please save
                    the form first.
                  </Typography>
                </Box>
              </Card>
