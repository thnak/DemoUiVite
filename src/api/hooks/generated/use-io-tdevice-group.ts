...
export function useGetIoTDeviceGroupPage(
  ...
  return useMutation({
    ...
    }) => getIoTDeviceGroupPage(variables.data, variables.params),
    ...options,
  });
}
...
export function useCreateIoTDeviceGroup(
  options?: Omit<
    UseMutationOptions<IoTDeviceGroupEntityResult, Error, { data: IoTDeviceGroupEntity }>,
    'mutationFn'
  >
) {
  return useMutation({
...
export function useUpdateIoTDeviceGroup(
  ...
  return useMutation({
    mutationFn: (variables: { id: string; data: StringObjectKeyValuePair[] }) =>
      updateIoTDeviceGroup(variables.id, variables.data),
    ...options,
  });
}
